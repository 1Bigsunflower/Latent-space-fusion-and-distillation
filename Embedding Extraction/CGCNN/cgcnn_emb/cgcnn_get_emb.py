...
def get_element_embedding_cgcnn(model, elem_list):
    ...
    for elem in elem_list:
        ...
        with torch.no_grad():
            emb = embedding_layer(elem_z_tensor)

        element_embeddings[elem] = emb.cpu().numpy().squeeze(0)
...
if __name__ == '__main__':
    ...
    for task in mb.tasks:
        ...
        for fold in task.folds:
            ...
            # 加载模型
            model_dir = f"../../../pre-train_model/cgcnn/cgcnn_emb/Cgcnn_{args.task_name}_emb_fold{args.fold}_dim{args.atom_fea_len}/"
            ...
            save_path = f"../../../Embedding_weight_orig/CGCNN/cgcnn_emb/{args.task_name}_fold{args.fold}_dim{args.atom_fea_len}.csv"
