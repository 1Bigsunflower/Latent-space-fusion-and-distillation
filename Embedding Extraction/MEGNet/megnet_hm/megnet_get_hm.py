...
if __name__ == '__main__':
    ...
    model_dir = f"../../../pre-train_model/megnet/megnet_hm/{args.task_name}_fold{args.fold}_dim{args.dim_node_embed}/"
    ...
    for task in mb.tasks:
        ...
        for fold in task.folds:
            ...
            # 构造保存路径
            save_path = f"../../../Embedding_weight_orig/MEGNet/megnet_hm/{args.task_name}_fold{args.fold}_dim{args.dim_node_embed}.csv"
