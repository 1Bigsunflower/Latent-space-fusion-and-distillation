        ...
        with torch.no_grad():
            for batch_idx, (x, y) in enumerate(dataloader):
                ...
                for crys_idx, atom_ids in enumerate(x[3]):
                    atom_to_crystal_idx[atom_ids] = crys_idx
                ...
                batch_data = {
                    ...
                    'atom_to_crystal': atom_to_crystal_idx.cpu()
                }
...
def main():
    ...
    for task in mb.tasks:
        ...
        for fold in task.folds:
            ...
            # 加载模型
            model_dir = f"../../pre-train_model/cgcnn/cgcnn_hm/Cgcnn_{task.dataset_name}_fold{fold}_dim{args.atom_fea_len}/"
