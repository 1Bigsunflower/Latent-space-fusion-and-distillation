...
if __name__ == '__main__':
    ...
    for task in mb.tasks:
        ...
        for fold in task.folds:
            ...
            early_stop_callback = EarlyStopping(monitor="val_MAE", min_delta=0.00, patience=300, verbose=True, mode="min")
            ...
            # Training
            trainer = pl.Trainer(max_epochs=10, enable_progress_bar=True, callbacks=[early_stop_callback, checkpoint_callback],
