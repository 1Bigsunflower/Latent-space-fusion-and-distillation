    ...
    for task in mb.tasks:
        ...
        for fold in task.folds:
            ...
            dataset = StruData(
                ...
                cache_path=f"cache/{args.subset}_precompute_r8_M12.pt",
                rebuild_cache=False,
                chunksize=16,
            )
            ...
            early_stop_callback = EarlyStopping(monitor="val_MAE", min_delta=0.00, patience=300, verbose=True,
                                                mode="min", )
            checkpoint_callback = ModelCheckpoint(
                monitor='val_MAE',
                save_top_k=1,
                mode='min',
                dirpath=f'Cgcnn_{task.dataset_name}_fold{fold}_dim{args.atom_fea_len}_e{args.a}_f{args.b}',
